...
<a class="btn btn-outline-danger" href="logout.do" > LogOut </a>
 ...
 <form action="aUpdate.do" method="post">
  ...
  <label class="control-label">Nom Aeroport:</label>
  <input type="text" name="nomAeroportN" value="${aeroport.nomAeroport}" class="form-control" />
  <input type="hidden" name="nomAeroportA" value="${aeroport.nomAeroport}"/>
