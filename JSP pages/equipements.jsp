...
<a class="btn btn-outline-danger" href="logout.do"> LogOut </a>
  ...
  <p></p>
    ...
    <!-- <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="index.do">Recherche Des Equipements</a>
      </li>
      <li class="nav-item">
  ...
  <label></label>
  <input type="text" name="numero_serie" placeholder="Numero Serie/Asset Tag" value="${model.numero_serie}"/>
  ...
  <c:forEach items="${model.equipements}" var="e">
  <tr>
