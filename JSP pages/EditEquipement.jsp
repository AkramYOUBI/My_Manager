 ...
 <!-- <image src="D:\Eclipse\Stage SITA\My_Manager0.png" align="middle" width="300" height="120"> -->
  ...
  <p style="color:#139fdb"> Let's move the world, together </p>
    ...
    <ul class="nav nav-tabs card-header-tabs">
      ...
      <!-- <li class="nav-item">
        <a class="nav-link " href="SaisieStock.do">Saisie D'un Equipement en Stock</a>
      </li> --> 
  ...
  <!-- <div class="card-body">
    ...
    <p class="card-text">Let's move the world, together</p>  
  </div> -->
 <form action="UpdateEquipement.do" method="post">
  <div class="form-group">
  <label class="control-label">Numéro Série:</label>
  <input type="text" name="numero_serie" value="${equipement.numero_serie}" required="required" class="form-control" />
  <span></span>
  </div>
  <div class="form-group">
  <label class="control-label">Asset Tag:</label>
  <input type="text" name="assets_tag" value="${equipement.assets_tag}" required="required" class="form-control"/>
  <span></span>
  </div>
  <div class="form-group">
  <label class="control-label">Model:</label>
  <input type="text" name="model" value="${equipement.model}" required="required" class="form-control"/>
  <span></span>
  </div>
  <div class="form-group">
